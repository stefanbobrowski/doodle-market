    ...
    <div>
      ...
      <section>
        ...
        <p>
          ...
          labore et dolore magna aliqua. This is a really long paragraph. Lorem
          ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua. This is a really
          long paragraph. Lorem ipsum dolor sit amet, consectetur adipiscing
        ...
        <pre>
          <code className='error'>Error: Some error text in a code block</code>
        </pre>
        <pre>
          <code>
            {`function example() {
